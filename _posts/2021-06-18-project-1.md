...
<span style="color: blue"> __The first project is titled Developing a method for a satellite-based soil moisture retrieval algorithm using GPS signals__</span>.
